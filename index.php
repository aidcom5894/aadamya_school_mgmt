...
<!-- Favicon -->
<link rel="shortcut icon" type="image/x-icon" href="modules/ui/assets/images/favicon.png">
<!-- CSS
============================================ -->
<link rel="stylesheet" href="modules/ui/assets/css/vendor/bootstrap.min.css">
<link rel="stylesheet" href="modules/ui/assets/css/vendor/icomoon.css">
<link rel="stylesheet" href="modules/ui/assets/css/vendor/remixicon.css">
<link rel="stylesheet" href="modules/ui/assets/css/vendor/magnifypopup.min.css">
<link rel="stylesheet" href="modules/ui/assets/css/vendor/odometer.min.css">
<link rel="stylesheet" href="modules/ui/assets/css/vendor/lightbox.min.css">
<link rel="stylesheet" href="modules/ui/assets/css/vendor/animation.min.css">
<link rel="stylesheet" href="modules/ui/assets/css/vendor/jqueru-ui-min.css">
<link rel="stylesheet" href="modules/ui/assets/css/vendor/swiper-bundle.min.css">
<link rel="stylesheet" href="modules/ui/assets/css/vendor/tipped.min.css">

<!-- Site Stylesheet -->
<link rel="stylesheet" href="modules/ui/assets/css/app.css">
...
<div class="logo">
<a href="index.html">
<img class="logo-light" src="modules/ui/assets/images/logo/logo-dark-2.png" alt="Corporate Logo">
<img class="logo-dark" src="modules/ui/assets/images/logo/logo-light-2.png" alt="Corporate Logo">
...
<img src="modules/ui/assets/images/others/mega-menu-image.webp" alt="advertising Image">
</a>
</li>
</ul>
</li>
...
<div class="logo">
<a href="index.html">
<img class="logo-light" src="modules/ui/assets/images/logo/logo-dark.png" alt="Corporate Logo">
<img class="logo-dark" src="modules/ui/assets/images/logo/logo-white.png" alt="Corporate Logo">
</a>
</div>
...
<img data-transform-origin='center center' data-src="modules/ui/assets/images/bg/bg-image-17.webp" class="swiper-lazy" alt="image">
...
<div class="swiper-slide">
<img data-transform-origin='center center' data-src="modules/ui/assets/images/bg/bg-image-28.webp" class="swiper-lazy" alt="image">
<div class="thumbnail-bg-content">
<div class="container edublink-animated-shape">
<div class="row">
<div class="col-7">
...
<div class="swiper-slide">
<img data-transform-origin='center center' data-src="modules/ui/assets/images/bg/bg-image-26.webp" class="swiper-lazy" alt="image">
<div class="thumbnail-bg-content">
<div class="container edublink-animated-shape">
<div class="row">
<div class="col-7">
...
<img data-depth="2" src="modules/ui/assets/images/others/shape-10.png" alt="Shape">
</li>
<li class="shape-2 scene" data-sal-delay="1000" data-sal="fade" data-sal-duration="1000">
<img data-depth="-3" src="modules/ui/assets/images/others/shape-11.png" alt="Shape">
</li>
<li class="shape-3">
<img src="modules/ui/assets/images/others/shape-25.png" alt="Shape">
</li>
</ul>
</div>
<!--=====================================-->
...
<div class="icon">
<img class="svgInject" src="modules/ui/assets/images/animated-svg-icons/scholarship-facility.svg" alt="animated icon">
<!-- <i class="icon-34"></i> -->
</div>
<div class="content">
...
<div class="icon">
<img class="svgInject" src="modules/ui/assets/images/animated-svg-icons/skilled-lecturers.svg" alt="animated icon">
</div>
<div class="content">
...
<div class="icon">
<img class="svgInject" src="modules/ui/assets/images/animated-svg-icons/book-library.svg" alt="animated icon">
<!-- <i class="icon-36"></i> -->
</div>
<div class="content">
...
<img class="main-img-1" data-sal-delay="100" data-sal="slide-up" data-sal-duration="800" src="modules/ui/assets/images/about/about-04.webp" alt="About Image">
<img class="main-img-2" data-sal-delay="100" data-sal="slide-left" data-sal-duration="800" src="modules/ui/assets/images/about/about-05.webp" alt="About Image">
<ul class="shape-group">
<li class="shape-1 scene" data-sal-delay="500" data-sal="fade" data-sal-duration="200">
<img data-depth="2" src="modules/ui/assets/images/about/shape-13.png" alt="Shape">
</li>
<li class="shape-2 scene" data-sal-delay="500" data-sal="fade" data-sal-duration="200">
<img data-depth="-2" src="modules/ui/assets/images/about/shape-39.png" alt="Shape">
</li>
<li class="shape-3 scene" data-sal-delay="500" data-sal="fade" data-sal-duration="200">
<img data-depth="2" src="modules/ui/assets/images/about/shape-07.png" alt="Shape">
</li>
...
<ul class="shape-group">
<li class="shape-5">
<img class="rotateit" src="modules/ui/assets/images/about/shape-13.png" alt="Shape">
</li>
<li class="shape-6">
<span></span>
</li>
...
<img src="modules/ui/assets/images/course/course-08.jpg" alt="Course Meta">
</a>
<div class="time-top">
...
<div class="thumbnail">
<a href="course-details.html">
<img src="modules/ui/assets/images/course/course-09.jpg" alt="Course Meta">
</a>
<div class="time-top">
<span class="duration"><i class="icon-61"></i>Online + Onsite</span>
</div>
...
<div class="thumbnail">
<a href="course-details.html">
<img src="modules/ui/assets/images/course/course-10.jpg" alt="Course Meta">
</a>
<div class="time-top">
...
<ul class="shape-group">
<li class="shape-1">
<img class="d-block-shape-light" data-depth="2" src="modules/ui/assets/images/others/map-shape-3.png" alt="Shape">
<img class="d-none-shape-dark" data-depth="2" src="modules/ui/assets/images/others/3-Home-1.png" alt="Shape">
</li>
<li class="shape-2">
<img class="d-block-shape-light" data-depth="2" src="modules/ui/assets/images/others/map-shape-3.png" alt="Shape">
<img class="d-none-shape-dark" data-depth="2" src="modules/ui/assets/images/others/dark-map-shape-3.png" alt="Shape">
</li>
</ul>
</div>
<!-- End Course Area -->
...
<div class="thumbnail">
<img src="modules/ui/assets/images/others/campus-01.webp" alt="Campus">
</div>
</div>
<ul class="shape-group">
...
<img data-depth="1.5" src="modules/ui/assets/images/about/shape-21.png" alt="Shape">
</li>
<li class="shape-3 scene">
<img data-depth="-1.5" src="modules/ui/assets/images/about/shape-13.png" alt="Shape">
</li>
</ul>
</div>
</div>
...
<img data-depth="-2" src="modules/ui/assets/images/about/shape-25.png" alt="Shape">
</li>
</ul>
</div>
</div>
...
<div class="content">
<div class="logo"><img src="modules/ui/assets/images/testimonial/logo-01.png" alt="Logo"></div>
...
<div class="thumb">
<img src="modules/ui/assets/images/testimonial/testimonial-01.png" alt="Testimonial">
</div>
<div class="info">
...
<div class="testimonial-slide">
<div class="content">
<div class="logo"><img src="modules/ui/assets/images/testimonial/logo-02.png" alt="Logo"></div>
<p>Lorem ipsum dolor amet consectur elit adicing elit sed do umod tempor ux incididunt enim ad minim veniam quis nosrud citation laboris nisiste aliquip comodo perspiatix.</p>
<div class="rating-icon">
<i class="icon-23"></i>
<i class="icon-23"></i>
...
<div class="author-info">
<div class="thumb">
<img src="modules/ui/assets/images/testimonial/testimonial-02.png" alt="Testimonial">
</div>
<div class="info">
...
<div class="testimonial-slide">
<div class="content">
<div class="logo"><img src="modules/ui/assets/images/testimonial/logo-03.png" alt="Logo"></div>
<p>Lorem ipsum dolor amet consectur elit adicing elit sed do umod tempor ux incididunt enim ad minim veniam quis nosrud citation laboris nisiste aliquip comodo perspiatix.</p>
<div class="rating-icon">
<i class="icon-23"></i>
<i class="icon-23"></i>
...
<div class="author-info">
<div class="thumb">
<img src="modules/ui/assets/images/testimonial/testimonial-03.png" alt="Testimonial">
</div>
<div class="info">
...
<div class="author-info">
<div class="thumb">
<img src="modules/ui/assets/images/testimonial/testimonial-04.png" alt="Testimonial">
</div>
<div class="info">
...
<img data-depth="1.4" src="modules/ui/assets/images/about/shape-30.png" alt="Shape">
</li>
<li class="shape-2 scene" data-sal-delay="200" data-sal="fade" data-sal-duration="1000">
<img data-depth="-1.4" src="modules/ui/assets/images/about/shape-25.png" alt="Shape">
</li>
</ul>
</div>
<ul class="shape-group">
...
<img class="d-block-shape-light" data-depth="2" src="modules/ui/assets/images/others/map-shape-3.png" alt="Shape">
<img class="d-none-shape-dark" data-depth="2" src="modules/ui/assets/images/others/dark-map-2-shape-3.png" alt="Shape">
</li>
</ul>
</div>
...
<img src="modules/ui/assets/images/event/event-01.jpg" alt="Blog Images">
</a>
...
<div class="thumbnail">
<a href="event-details.html">
<img src="modules/ui/assets/images/event/event-02.jpg" alt="Blog Images">
</a>
<div class="event-time">
...
<div class="thumbnail">
<a href="event-details.html">
<img src="modules/ui/assets/images/event/event-03.jpg" alt="Blog Images">
</a>
<div class="event-time">
...
<img src="modules/ui/assets/images/brand/brand-01.png" alt="Brand Logo">
</div>
<div class="brand-grid">
<img src="modules/ui/assets/images/brand/brand-02.png" alt="Brand Logo">
</div>
<div class="brand-grid">
<img src="modules/ui/assets/images/brand/brand-03.png" alt="Brand Logo">
</div>
<div class="brand-grid">
<img src="modules/ui/assets/images/brand/brand-04.png" alt="Brand Logo">
</div>
<div class="brand-grid">
<img src="modules/ui/assets/images/brand/brand-05.png" alt="Brand Logo">
</div>
<div class="brand-grid">
<img src="modules/ui/assets/images/brand/brand-06.png" alt="Brand Logo">
</div>
</div>
</div>
</div>
...
<img data-depth="2.5" src="modules/ui/assets/images/cta/shape-10.png" alt="shape">
</li>
<li class="shape-02 scene">
<img data-depth="-2.5" src="modules/ui/assets/images/cta/shape-09.png" alt="shape">
</li>
<li class="shape-03 scene">
<img data-depth="-2" src="modules/ui/assets/images/cta/shape-08.png" alt="shape">
</li>
...
<div class="logo">
<a href="index.html">
<img class="logo-light" src="modules/ui/assets/images/logo/logo-light-2.png" alt="Corporate Logo">
</a>
</div>
...
============================================ -->
<!-- Modernizer JS -->
<script src="modules/ui/assets/js/vendor/modernizr.min.js"></script>
<!-- Jquery Js -->
<script src="modules/ui/assets/js/vendor/jquery.min.js"></script>
<script src="modules/ui/assets/js/vendor/bootstrap.min.js"></script>
<script src="modules/ui/assets/js/vendor/sal.min.js"></script>
<script src="modules/ui/assets/js/vendor/backtotop.min.js"></script>
<script src="modules/ui/assets/js/vendor/magnifypopup.min.js"></script>
<script src="modules/ui/assets/js/vendor/jquery.countdown.min.js"></script>
<script src="modules/ui/assets/js/vendor/odometer.min.js"></script>
<script src="modules/ui/assets/js/vendor/isotop.min.js"></script>
<script src="modules/ui/assets/js/vendor/imageloaded.min.js"></script>
<script src="modules/ui/assets/js/vendor/lightbox.min.js"></script>
<script src="modules/ui/assets/js/vendor/paralax.min.js"></script>
<script src="modules/ui/assets/js/vendor/paralax-scroll.min.js"></script>
<script src="modules/ui/assets/js/vendor/jquery-ui.min.js"></script>
<script src="modules/ui/assets/js/vendor/swiper-bundle.min.js"></script>
<script src="modules/ui/assets/js/vendor/svg-inject.min.js"></script>
<script src="modules/ui/assets/js/vendor/vivus.min.js"></script>
<script src="modules/ui/assets/js/vendor/tipped.min.js"></script>
<script src="modules/ui/assets/js/vendor/smooth-scroll.min.js"></script>
<script src="modules/ui/assets/js/vendor/isInViewport.jquery.min.js"></script>

<!-- Site Scripts -->
<script src="modules/ui/assets/js/app.js"></script>
</body>
